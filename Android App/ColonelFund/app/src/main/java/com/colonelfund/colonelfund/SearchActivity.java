...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postArrayList.add(new Post("John Smith", "JohnSmith"));
        postArrayList.add(new Post("Wayne Brady", "WayneBrady"));
        postArrayList.add(new Post("Great Gonzales", "GreatGonzales"));
        postArrayList.add(new Post("Lord British", "LordBritish"));
        postArrayList.add(new Post("Stanley Hutts", "StanHutt"));
        postArrayList.add(new Post("Han Solo", "YoloSolo"));
        postArrayList.add(new Post("Frodo Baggins", "FBaggins"));
